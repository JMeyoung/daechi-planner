    ...
    <tr><td align="center">
      <table width="480" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;border:1px solid #e5e7eb;overflow:hidden">
        <tr><td style="background:linear-gradient(135deg,#1d4ed8,#2563eb);padding:32px 32px 24px;text-align:center">
          ...
          <h1 style="margin:0;color:#fff;font-size:22px;font-weight:700">프리미엄 구독 시작!</h1>
        </td></tr>
        <tr><td style="padding:32px">
          <p style="margin:0 0 24px;color:#374151;font-size:15px;line-height:1.6">안녕하세요!<br>대치 플래너 프리미엄 구독이 성공적으로 시작되었습니다.</p>
          ...
          <a href="https://daechi-planner.vercel.app/briefings" style="display:block;text-align:center;background:#2563eb;color:#fff;font-size:15px;font-weight:600;padding:14px;border-radius:12px;text-decoration:none">브리핑 보러가기</a>
      ...
      <table width="520" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;border:1px solid #e5e7eb;overflow:hidden">
        ...
        <tr><td style="padding:32px">
          ...
          <div style="margin-top:32px;padding-top:24px;border-top:1px solid #f3f4f6;text-align:center">
            <a href="https://daechi-planner.vercel.app/briefings" style="display:inline-block;background:#2563eb;color:#fff;font-size:14px;font-weight:600;padding:12px 28px;border-radius:12px;text-decoration:none">브리핑 전체 보기</a>
          </div>
